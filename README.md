...
- Criei códigos que utilizavam estruturas condicionais, como o if/else;
- Manipulei arrays (listas);
- Utilizei o comando for;
- Quebrei grandes problemas em pequenos;
- Utilizei lógica de programação na resolução de problemas;
- Manipulei objetos;
- Utilizei o comando for/in;
- Utilizei funções para organizar e estruturar o meu código;

---

## Tecnologias utilizadas
Neste projeto foi utilizado a linguagem de programação JavaScript.
...
```javascript
  ...
  git clone git@github.com:Humberto-Bonadiman/Project-playground-functions.git
```
